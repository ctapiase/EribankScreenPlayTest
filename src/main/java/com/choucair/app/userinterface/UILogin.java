...
public class UILogin {
    ...
    //public static final Target LOGIN_SUCCESSFULL_TXT= Target.the("Logeo Exitoso").locatedForAndroid("//android.widget.TextView[@text=\"Your balance is: 100.00$\"]").locatedForIOS();
